...
const createWindow = () => {
    const win = new BrowserWindow({
        ...
        height: 600,
        webPreferences: {
            preload: path.join(__dirname, 'middleware/main.js'),
...
app.whenReady().then(() => {
    ...
    //createFromPath('assets/icon.ico')
    tray = new Tray(icon)
    ...
    console.log(new Notification({ title: 'Basic Notification', body: 'Notification from the Main process' }).show());
